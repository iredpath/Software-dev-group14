...
public class WorkbookReader {
    ...
    void readFile() throws Exception {
        ...
        File f = new File("/Users/Ian/Desktop/software-dev/samples/191137- ATT 2 NEG.xlsx");
        ...
        for (int i = 0; i < numSheets; i++) {
            ...
            String stimName = sheet.getSheetName();
            if (stimName.contains(" - ")) {
            ...
            if (sheet != null) {
                ...
                while (true) {
                    ...
                    if (row == null) { // no value
                        ...
                        data.set(fileName, stimuli, stimuli + "-SM", statName, value);
                        rowIndex++;
                    }
                }
            }
